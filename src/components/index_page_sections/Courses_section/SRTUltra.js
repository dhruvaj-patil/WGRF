...
const SRTUltra = (props)=>(

    <div className={container.locationContainer}>
    <div style={{padding:"0px"}}className={`${container.containerLeft} ${container.inverseLeft}`}>
    ...
    <div style={{padding:"20px"}} className={container.inverseContainerRight}>


      <div style={{ flex: 1 }}>
        <h2 style={{ textAlign: "center" }}>SRT ULTRA</h2>
      </div>
      <div
      ...
      >
        ...
        <div style={{bottom:'0px'}} className={`${container.indicatorContainer}`}>
          <div
